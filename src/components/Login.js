...
const Login = () => {
  ...
  return (
    <div className="">
      ...
      <form
        className=" w-full absolute md:w-3/12 mx-auto p-2 md:p-12 bg-black text-white my-24 md:my-36 left-0 right-0 opacity-80"
        onSubmit={(e) => {
          e.preventDefault()
        }}
      >
        ...
        <input
          type="text"
          placeholder="email"
          className="p-4 my-4 bg-gray-900 w-full "
          ref={email}
        />
        <input
          type="password"
